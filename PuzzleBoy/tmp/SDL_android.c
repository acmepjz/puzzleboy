...
int Android_JNI_SetClipboardText(const char* text)
{
    ...
    mid = (*env)->GetStaticMethodID(env, mActivityClass, "clipboardSetText", "(Ljava/lang/String;)V");
    string = (*env)->NewStringUTF(env, text);
    (*env)->CallStaticVoidMethod(env, mActivityClass, mid, string);
...
char* Android_JNI_GetClipboardText()
{
    ...
    mid = (*env)->GetStaticMethodID(env, mActivityClass, "clipboardGetText", "()Ljava/lang/String;");
    string = (*env)->CallStaticObjectMethod(env, mActivityClass, mid);
    if (string) {
...
SDL_bool Android_JNI_HasClipboardText()
{
    ...
    mid = (*env)->GetStaticMethodID(env, mActivityClass, "clipboardHasText", "()Z");
    retval = (*env)->CallStaticBooleanMethod(env, mActivityClass, mid);
